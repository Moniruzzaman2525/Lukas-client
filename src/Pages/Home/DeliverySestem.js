...
const DeliverySestem = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-3 mx-5 my-32'>
            <div className='flex mx-auto'>
                <div className='mr-5 mt-5'>
                    <img src="https://htmldemo.net/lukas/lukas/assets/img/icons/icon-1.png" alt="" />
                </div>
                <div className=''>
                    <h2 className='text-2xl mb-2 text-success font-bold'>Free Home Delivery</h2>
            ...
            <div className='flex mx-auto'>
                ...
                <div>
                    <h2 className='text-2xl mb-2 text-success font-bold'>Quality Products</h2>
            ...
            <div className='flex mx-auto'>
                ...
                <div>
                    <h2 className='text-2xl mb-2 text-success font-bold'>Online Support</h2>
