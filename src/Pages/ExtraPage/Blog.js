...
const Blog = () => {
    return (
        <div className='container mx-auto'>
            <div className="my-10">
                <h2 className="text-2xl font-semibold mb-5">How will you improve the performance of a React Application?</h2>
            ...
            <div className="my-10">
                <h2 className="text-2xl font-semibold mb-5">What are the different ways to manage a state in a React application?</h2>
            ...
            <div className="my-10">
                <h2 className="text-2xl font-semibold mb-5">How does prototypical inheritance work?</h2>
            ...
            <div className="my-10">
                <h2 className="text-2xl font-semibold mb-5">Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h2>
            ...
            <div className="my-10">
                <h2 className="text-2xl font-semibold mb-5">You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h2>
            ...
            <div className="my-10">
                <h2 className="text-2xl font-semibold mb-5">What is a unit test? Why should write unit tests?</h2>
                <p className='text-xl'>
